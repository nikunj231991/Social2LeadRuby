  ...
  $.extend(DateRangePicker.prototype, {
    ...
    setupContainer: function () {
      ...
      var dates = '<span id="date-fields">Dates:' +
        '<input type="text" class="drp-input-startdate" size="10" readonly> -' +
        ' <input type="text" class="drp-input-enddate" size="10" readonly></span>';

      var select = '<select class="drp-select-daterange">' +
      ...
      var controls = '<span><a href="" class="drp-btn-cancel">cancel</a></span>' +
        '<span><button class="drp-btn-apply">Apply</button></span>';

      var datepickerContainer = '<div class="drp-container-datepicker"></div>';
    ...
    initializeDatePicker: function () {
      ...
      $(document).click(function (event) {
        ...
        if (!($target.attr('id') === self._$element.attr('id') ||
          $target.closest('#socialLeadDateRangePickerContainer, .ui-datepicker-header').length || $target.closest('#analyticsDateRangePickerContainer, .ui-datepicker-header').length)) {
